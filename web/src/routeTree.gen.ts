...
import { Route as CanvasLaunchRouteImport } from './routes/canvas-launch'
...
const CanvasLaunchRoute = CanvasLaunchRouteImport.update({
  id: '/canvas-launch',
  path: '/canvas-launch',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  '/': typeof IndexRoute
  '/canvas-launch': typeof CanvasLaunchRoute
...
export interface RootRouteChildren {
  ...
  CanvasLaunchRoute: typeof CanvasLaunchRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/canvas-launch': {
      id: '/canvas-launch'
      path: '/canvas-launch'
      fullPath: '/canvas-launch'
      preLoaderRoute: typeof CanvasLaunchRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/privacy-policy': {
      id: '/privacy-policy'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  CanvasLaunchRoute: CanvasLaunchRoute,
